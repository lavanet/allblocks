...
class LavaSDK {
    ...
    static generateKey() {
        return __awaiter(this, void 0, void 0, function* () {
            const dynamicWallet = yield (0, wallet_1.createDynamicWallet)();
    ...
    handleRpcRelay(options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.sendRelayWithRetries(sendRelayOptions, cuSum);
            }
            catch (err) {
                throw err;
            }
    ...
    sendRelayWithRetries(options, cuSum) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check if relay was initialized
            if (this.relayer instanceof Error) {
                throw errors_1.default.errRelayerServiceNotInitialized;
            ...
            const [pairingList, extendedPairingList] = yield this.getConsumerProviderSession();
            ...
            if (pairingList.length == 0) {
                throw new Error("sendRelayWithRetries couldn't find pairing list for this epoch.");
            }
    ...
    getConsumerProviderSession() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Return randomized pairing list, our geolocation index 0 and other geolocation index 1
            return [
                this.lavaProviders.pickRandomProviders(this.activeSessionManager.PairingList),
                this.lavaProviders.pickRandomProviders(this.activeSessionManager.PairingListExtended),
            ];
        });
    }
    newEpochStarted() {
