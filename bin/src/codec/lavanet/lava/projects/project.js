...
exports.Project = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.adminPolicy !== undefined) {
            policy_1.Policy.encode(message.adminPolicy, writer.uint32(50).fork()).ldelim();
        }
        if (!message.usedCu.isZero()) {
            writer.uint32(56).uint64(message.usedCu);
        }
        if (message.subscriptionPolicy !== undefined) {
            policy_1.Policy.encode(message.subscriptionPolicy, writer.uint32(66).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    message.adminPolicy = policy_1.Policy.decode(reader, reader.uint32());
                    continue;
                case 7:
                    if (tag != 56) {
                        break;
                ...
                case 8:
                    ...
                    message.subscriptionPolicy = policy_1.Policy.decode(reader, reader.uint32());
                    continue;
                case 9:
                    if (tag != 72) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            adminPolicy: isSet(object.adminPolicy) ? policy_1.Policy.fromJSON(object.adminPolicy) : undefined,
            usedCu: isSet(object.usedCu) ? long_1.default.fromValue(object.usedCu) : long_1.default.UZERO,
            subscriptionPolicy: isSet(object.subscriptionPolicy) ? policy_1.Policy.fromJSON(object.subscriptionPolicy) : undefined,
    ...
    toJSON(message) {
        ...
        message.adminPolicy !== undefined &&
            (obj.adminPolicy = message.adminPolicy ? policy_1.Policy.toJSON(message.adminPolicy) : undefined);
        message.usedCu !== undefined && (obj.usedCu = (message.usedCu || long_1.default.UZERO).toString());
        message.subscriptionPolicy !== undefined &&
            (obj.subscriptionPolicy = message.subscriptionPolicy ? policy_1.Policy.toJSON(message.subscriptionPolicy) : undefined);
    ...
    fromPartial(object) {
        ...
        message.adminPolicy = (object.adminPolicy !== undefined && object.adminPolicy !== null)
            ? policy_1.Policy.fromPartial(object.adminPolicy)
            : undefined;
        ...
        message.subscriptionPolicy = (object.subscriptionPolicy !== undefined && object.subscriptionPolicy !== null)
            ? policy_1.Policy.fromPartial(object.subscriptionPolicy)
            : undefined;
...
exports.ProjectData = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.policy !== undefined) {
            policy_1.Policy.encode(message.policy, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            enabled: isSet(object.enabled) ? Boolean(object.enabled) : false,
            projectKeys: Array.isArray(object === null || object === void 0 ? void 0 : object.projectKeys) ? object.projectKeys.map((e) => exports.ProjectKey.fromJSON(e)) : [],
            policy: isSet(object.policy) ? policy_1.Policy.fromJSON(object.policy) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
