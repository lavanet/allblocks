...
const query_1 = require("../codec/lavanet/lava/pairing/query");
const query_2 = require("../codec/lavanet/lava/spec/query");
const lavaPairing_1 = require("../util/lavaPairing");
const errors_1 = __importDefault(require("./errors"));
const common_1 = require("../util/common");
const query_3 = require("../codec/lavanet/lava/spec/query");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const provider of providers) {
                ...
                for (const endpoint of provider.endpoints) {
                    ...
                    if ((0, common_1.parseLong)(endpoint.geolocation) == Number(this.geolocation)) {
                ...
                0, // latestRelayCuSum
                1, // relayNumber
                endpointListToStore[0], (0, common_1.parseLong)(pairingResponse.currentEpoch), provider.address);
                // Create a new pairing object
                const newPairing = new types_1.ConsumerSessionWithProvider(this.accountAddress, endpointListToStore, singleConsumerSession, maxcu, 0, // used compute units
                false);
                // Add newly created pairing in the pairing list
                if (sameGeoOptions) {
                    pairing.push(newPairing);
            ...
            const sessionManager = new types_1.SessionManager(pairing, pairingFromDifferentGeolocation, nextEpochStart, apis);
