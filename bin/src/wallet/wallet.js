...
class LavaWallet {
    ...
    printAccount(AccountData) {
        ...
        logger_1.Logger.info("Address: " + AccountData.address);
        logger_1.Logger.info("Public key: " + AccountData.pubkey);
...
function createDynamicWallet(mnemonicLength = 24) {
    return __awaiter(this, void 0, void 0, function* () {
        const walletWithRandomSeed = yield launchpad_1.Secp256k1HdWallet.generate(mnemonicLength, {
            prefix: lavaPrefix,
        });
