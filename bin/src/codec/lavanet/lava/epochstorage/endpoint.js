...
function createBaseEndpoint() {
    return { iPPORT: "", geolocation: long_1.default.UZERO, addons: [], apiInterfaces: [], extensions: [] };
}
exports.Endpoint = {
    ...
    fromPartial(object) {
        ...
        message.extensions = ((_d = object.extensions) === null || _d === void 0 ? void 0 : _d.map((e) => e)) || [];
        return message;
    },
};
