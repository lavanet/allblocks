...
exports.ApiList = {
    ...
    fromPartial(object) {
        ...
        message.addon = (_c = object.addon) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
...
exports.QueryShowChainInfoResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            supportedApisInterfaceList: Array.isArray(object === null || object === void 0 ? void 0 : object.supportedApisInterfaceList)
                ...
                : [],
            optionalInterfaces: Array.isArray(object === null || object === void 0 ? void 0 : object.optionalInterfaces)
                ? object.optionalInterfaces.map((e) => String(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.optionalInterfaces = ((_d = object.optionalInterfaces) === null || _d === void 0 ? void 0 : _d.map((e) => e)) || [];
        return message;
    },
};
