...
exports.RelayerClientImpl = exports.QualityOfServiceReport = exports.RelayReply = exports.RelayRequest = exports.Metadata = exports.RelayPrivateData = exports.Badge = exports.RelaySession = exports.ProbeReply = exports.ProbeRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseProbeRequest() {
    return { guid: long_1.default.UZERO, specId: "", apiInterface: "" };
}
exports.ProbeRequest = {
    ...
    fromJSON(object) {
        return {
            guid: isSet(object.guid) ? long_1.default.fromValue(object.guid) : long_1.default.UZERO,
    ...
    toJSON(message) {
        const obj = {};
        message.guid !== undefined && (obj.guid = (message.guid || long_1.default.UZERO).toString());
        message.specId !== undefined && (obj.specId = message.specId);
        message.apiInterface !== undefined && (obj.apiInterface = message.apiInterface);
        return obj;
    },
    create(base) {
        return exports.ProbeRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseProbeRequest();
        message.guid = (object.guid !== undefined && object.guid !== null) ? long_1.default.fromValue(object.guid) : long_1.default.UZERO;
        message.specId = (_a = object.specId) !== null && _a !== void 0 ? _a : "";
        message.apiInterface = (_b = object.apiInterface) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
function createBaseProbeReply() {
    return { guid: long_1.default.UZERO, latestBlock: long_1.default.ZERO, finalizedBlocksHashes: new Uint8Array(), lavaEpoch: long_1.default.UZERO };
}
exports.ProbeReply = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.guid.isZero()) {
    ...
    fromJSON(object) {
        return {
            ...
            finalizedBlocksHashes: isSet(object.finalizedBlocksHashes)
                ...
                : new Uint8Array(),
            lavaEpoch: isSet(object.lavaEpoch) ? long_1.default.fromValue(object.lavaEpoch) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.lavaEpoch !== undefined && (obj.lavaEpoch = (message.lavaEpoch || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
        return exports.ProbeReply.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseProbeReply();
        ...
        message.latestBlock = (object.latestBlock !== undefined && object.latestBlock !== null)
            ...
            : long_1.default.ZERO;
        message.finalizedBlocksHashes = (_a = object.finalizedBlocksHashes) !== null && _a !== void 0 ? _a : new Uint8Array();
        message.lavaEpoch = (object.lavaEpoch !== undefined && object.lavaEpoch !== null)
            ? long_1.default.fromValue(object.lavaEpoch)
...
exports.RelayPrivateData = {
    ...
    fromPartial(object) {
        ...
        message.addon = (_g = object.addon) !== null && _g !== void 0 ? _g : "";
        message.extensions = ((_h = object.extensions) === null || _h === void 0 ? void 0 : _h.map((e) => e)) || [];
        return message;
    },
};
...
class RelayerClientImpl {
    ...
    Probe(request) {
        const data = exports.ProbeRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Probe", data);
        return promise.then((data) => exports.ProbeReply.decode(minimal_1.default.Reader.create(data)));
    }
}
