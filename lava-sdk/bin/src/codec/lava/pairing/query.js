...
function createBaseQueryVerifyPairingResponse() {
    return { valid: false, pairedProviders: long_1.default.UZERO, cuPerEpoch: long_1.default.UZERO, projectId: "" };
}
...
exports.QueryEffectivePolicyRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.consumer !== "") {
    ...
    create(base) {
        return exports.QueryEffectivePolicyRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryEffectivePolicyRequest();
...
exports.QueryEffectivePolicyResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.policy !== undefined) {
            policy_1.Policy.encode(message.policy, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.policy = policy_1.Policy.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) == 4 || tag == 0) {
                break;
    ...
    fromJSON(object) {
        return { policy: isSet(object.policy) ? policy_1.Policy.fromJSON(object.policy) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.policy !== undefined && (obj.policy = message.policy ? policy_1.Policy.toJSON(message.policy) : undefined);
        return obj;
    },
    create(base) {
        return exports.QueryEffectivePolicyResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryEffectivePolicyResponse();
        message.policy = (object.policy !== undefined && object.policy !== null)
            ? policy_1.Policy.fromPartial(object.policy)
            : undefined;
        return message;
    },
};
function createBaseQuerySdkPairingResponse() {
    return { pairing: undefined, maxCu: long_1.default.UZERO, spec: undefined };
}
exports.QuerySdkPairingResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.pairing !== undefined) {
            exports.QueryGetPairingResponse.encode(message.pairing, writer.uint32(10).fork()).ldelim();
        }
        if (!message.maxCu.isZero()) {
            writer.uint32(16).uint64(message.maxCu);
        }
        if (message.spec !== undefined) {
            spec_1.Spec.encode(message.spec, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.pairing = exports.QueryGetPairingResponse.decode(reader, reader.uint32());
                    continue;
                case 2:
                    if (tag != 16) {
                        break;
    ...
    fromJSON(object) {
        return {
            pairing: isSet(object.pairing) ? exports.QueryGetPairingResponse.fromJSON(object.pairing) : undefined,
            maxCu: isSet(object.maxCu) ? long_1.default.fromValue(object.maxCu) : long_1.default.UZERO,
            spec: isSet(object.spec) ? spec_1.Spec.fromJSON(object.spec) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        message.pairing !== undefined &&
            (obj.pairing = message.pairing ? exports.QueryGetPairingResponse.toJSON(message.pairing) : undefined);
        message.maxCu !== undefined && (obj.maxCu = (message.maxCu || long_1.default.UZERO).toString());
        message.spec !== undefined && (obj.spec = message.spec ? spec_1.Spec.toJSON(message.spec) : undefined);
        return obj;
    },
    create(base) {
        return exports.QuerySdkPairingResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQuerySdkPairingResponse();
        message.pairing = (object.pairing !== undefined && object.pairing !== null)
            ? exports.QueryGetPairingResponse.fromPartial(object.pairing)
            : undefined;
        message.maxCu = (object.maxCu !== undefined && object.maxCu !== null) ? long_1.default.fromValue(object.maxCu) : long_1.default.UZERO;
...
class QueryClientImpl {
    ...
    EffectivePolicy(request) {
        const data = exports.QueryEffectivePolicyRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "EffectivePolicy", data);
        return promise.then((data) => exports.QueryEffectivePolicyResponse.decode(minimal_1.default.Reader.create(data)));
    }
    SdkPairing(request) {
        const data = exports.QueryGetPairingRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "SdkPairing", data);
        return promise.then((data) => exports.QuerySdkPairingResponse.decode(minimal_1.default.Reader.create(data)));
    }
}
